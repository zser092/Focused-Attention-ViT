...
class SPPPExperiment:
    """
    Experiment class for SPPP Vision Transformer training.
    """
    ...
    def save_results(self):
        ...
        # Save to CSV
        csv_path = os.path.join(self.results_dir, 'exp2_sppp.csv')
...
def main():
    ...
    import argparse
    parser = argparse.ArgumentParser(description='SPPP ViT Experiment')
